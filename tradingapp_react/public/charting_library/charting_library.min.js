//kmh this library called at first when the widget is created.
//kmh these funtions are called once and set parameteres of widget.
!(function (t, e) {
    ...
    //kmh excute at first when the widget is created.
    //kmh run these funtions one time and set properties of widget
	"use strict";
    //kmh "use strict" this is used in min.js and prove there is no gansop
	function e(t, o) {
		var i = n({}, t);
		for (var s in o)
	...
	}  //kmh get library version
	function i(t) {
		window.addEventListener("DOMContentLoaded", t, !1);
	}   //kmh add eventlistener of window to the widget.
	var n =
			Object.assign ||
			function (t) {
		...
		},     //kmh mobile preset adding options
		r = {
			width: 800,
			height: 500,
			symbol: "AA",
			...
			disabled_features: [],
			enabled_features: [],
			debug: !1,    //kmh develop mode e.g.debug:true 
			logo: {},
			time_frames: [
		...
		a = (function () {
			function t(t) {
				if (
					...
					throw new Error("Datafeed is not defined");         //kmh datafeed test
				...
				"Dark" === this._options.theme &&
					...
					this._create();     //kmh test widget whether Dark mode
			}
			return (
                //kmh widget functions you can call. e.g. widget.onChartReady()
					...
					return (
						...
						(this._options.autosize || this._options.fullscreen
							...
							: ' width="' +
							  ...
							  '"') +
						' frameborder="0" allowTransparency="true" scrolling="yes" allowfullscreen style="display:block;"></iframe>'
					);
				}),
				t
			);
		})(),  //kmh widget function class
		d = a;
	(window.TradingView = window.TradingView || {}),
		(window.TradingView.version = o),
		(t.version = o),
		(t.onready = i),
		(t.widget = d),  //kmh give function class to the widget
