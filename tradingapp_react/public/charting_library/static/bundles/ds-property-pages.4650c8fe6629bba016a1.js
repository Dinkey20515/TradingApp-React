webpackJsonp([3], {
	...
	1079: function (e, t, o) {
		...
		var n = o(1196),
			...
			h = o(373).addColorPicker,
			c = o(1198).createLineStyleEditor,
			b = o(1197).createLineWidthEditor,
			u = o(1199).createTransparencyEditor;
		inherit(i, n),
	...
	1084: function (e, t, o) {
		...
		(function (t) {
			...
			var n = o(1235),
				...
				_ = o(49),
				m = o(22),
				f = o(373).addColorPicker,
				L = o(1198).createLineStyleEditor,
				v = o(1197).createLineWidthEditor,
	...
	1085: function (e, t, o) {
		...
		var n = o(1196),
			...
			s = a.BooleanBinder,
			d = o(1197).createLineWidthEditor;
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
	...
	1086: function (e, t, o) {
		...
		var n = o(1196),
			...
			l = a.ColorBinding,
			p = a.SliderBinder,
			s = o(1197).createLineWidthEditor;
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				var e, t, o, i, n;
				(this._table = $(document.createElement("table"))),
	...
	1090: function (e, t, o) {
		...
		var n = o(1196),
			...
			p = a.SliderBinder,
			s = a.BooleanBinder,
			d = o(1198).createLineStyleEditor,
			h = o(1197).createLineWidthEditor;
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
	...
	1093: function (e, t, o) {
		...
		var n = o(1196),
			...
			l = a.ColorBinding,
			p = a.SliderBinder,
			s = o(1198).createLineStyleEditor,
			d = o(1197).createLineWidthEditor;
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				var e, t, o, i;
	...
	1105: function (e, t, o) {
		...
		var n = o(1196),
			...
			p = a.ColorBinding,
			s = a.SliderBinder,
			d = o(373).addColorPicker,
			h = o(1197).createLineWidthEditor,
			c = o(1199).createTransparencyEditor;
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t, o) {
				var i,
					n,
	...
	1107: function (e, t, o) {
		...
		var n = o(1196),
			...
			u = o(373).addColorPicker,
			C = o(1197).createLineWidthEditor,
			y = o(1199).createTransparencyEditor;
		o(242),
			inherit(i, n),
	...
	1108: function (e, t, o) {
		...
		var n = o(1196),
			...
			l = a.SliderBinder,
			p = a.ColorBinding,
			s = o(373).addColorPicker,
			d = o(1197).createLineWidthEditor,
			h = o(1199).createTransparencyEditor;
		inherit(i, n),
			(i.prototype.addOneColorPropertyWidget = function (e) {
				var t = this.createOneColorForAllLinesWidget(),
					o = $("<tr>");
	...
	1109: function (e, t, o) {
		...
		var n = o(1196),
			...
			s = a.SliderBinder,
			d = o(373).addColorPicker,
			h = o(1198).createLineStyleEditor,
			c = o(1197).createLineWidthEditor,
			b = o(1199).createTransparencyEditor;
		inherit(i, n),
			...
			(i.prototype.prepareLayout = function () {
				...
				this.addFannEditor(n),
					...
					(g = $(
						...
						$("<td>").css({ width: "50%", "vertical-align": "top" }).appendTo(y)
					)),
					(T = $(
						'<table class="property-page" cellspacing="0" cellpadding="0">'
					).appendTo(
	...
	1118: function (e, t, o) {
		...
		var n = o(1196),
			...
			r = a.ColorBinding,
			l = a.SliderBinder,
			p = o(1197).createLineWidthEditor;
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				var e,
					t,
	...
	1131: function (e, t, o) {
		...
		var n = o(239).PropertyPage,
			a = o(247).StudyInputsPropertyPage,
			r = o(1077),
			l = o(33),
			p = o(1202);
		inherit(i, r),
	...
	1132: function (e, t, o) {
		...
		var n = o(1235),
			...
			l = a.BooleanBinder,
			p = a.SimpleComboBinder,
			s = o(379).StudyStylesPropertyPage,
			d = o(49);
		inherit(i, r),
			inherit(i, n),
	...
	1133: function (e, t, o) {
		...
		var n = o(239),
			...
			p = n.SliderBinder,
			s = n.ColorBinding,
			d = o(379).StudyStylesPropertyPage,
			h = o(1197).createLineWidthEditor;
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				var e,
		...
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $(
					...
					(_ = o(379).StudyStylesPropertyPage),
	...
	1235: function (e, t, o) {
		...
		(function (t) {
			...
			var n = o(239),
				...
				u = n.SliderBinder,
				C = o(49),
				y = o(1197).createLineWidthEditor,
				g = o(1259).createPriceSourceEditor,
	...
	379: function (e, t, o) {
		...
		var a = o(239),
			...
			g = o(373).addColorPicker,
			T = o(1198).createLineStyleEditor,
			w = o(1263).createShapeLocationEditor,
			_ = o(1264).createShapeStyleEditor,
			m = o(1197).createLineWidthEditor,
			f = o(1265).createVisibilityEditor,
			L = o(1266).createHHistDirectionEditor,
			v = o(1236).createPlotEditor,
		...
		inherit(i, r),
			...
			(i._createRow_hhists = function (e, t) {
				...
				$("<td>").append(w).appendTo(T),
					...
					this.bindControl(
						new c(w, t.visible, !0, this.model(), "Change " + b + " Visibility")
					),
					(T = this.addRow(e)),
					(o = $("<input/>")),
					o.attr("type", "text"),
	...
	401: function (e, t, o) {
		...
		var a = o(1196),
			...
			p = l.PropertyPage,
			s = l.SliderBinder,
			d = o(1199).createTransparencyEditor,
			h = o(1202);
		inherit(i, r),
			(i.prototype.prepareLayout = function () {
				var e,
	...
	402: function (e, t, o) {
		...
		var a = o(1196),
			...
			h = l.ColorBinding,
			c = l.SliderBinder,
			b = o(1198).createLineStyleEditor,
			u = o(1197).createLineWidthEditor;
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
	...
	403: function (e, t, o) {
		...
		var a = o(1196),
			...
			y = l.BooleanBinder,
			g = o(1197).createLineWidthEditor,
			T = o(89).NumericFormatter;
		inherit(i, r),
			(i.prototype.prepareLayout = function () {
				function e(e) {
	...
	404: function (e, t, o) {
		...
		var a = o(1196),
			...
			C = l.SliderBinder,
			y = o(1198).createLineStyleEditor,
			g = o(1197).createLineWidthEditor,
			T = o(89).NumericFormatter;
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
